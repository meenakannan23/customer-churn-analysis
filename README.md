...
## 📌 Project Overview
This project analyzes customer churn behavior in a banking dataset to identify key factors influencing customer attrition. The goal is to derive actionable insights that help improve customer retention and business decision-making.
...
## 🧹 Data Cleaning (SQL)
- Checked for duplicate records using `CustomerId`
...
- Churned Customers
- Churn Rate
- Avg Age, Balance, Credit Score, Salary, Tenure
...
- Customers with **only one product** show higher churn rates
- **Inactive customers** have significantly higher churn
- Certain regions (e.g., Germany) exhibit higher churn levels
- Customers with moderate credit scores tend to churn more
